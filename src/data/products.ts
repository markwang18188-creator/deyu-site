...
export const products: Product[] = [
  ...
  },
  {
    ...
    modelSlug: 'dy-3324',
    model: 'DY-3324',
    name: 'Full Automatic Rotary Three-Head Three Color Sole Injection Moulding Machine',
    category: 'multi-color',
    shortDescription:
      '24-station rotary machine with 3 independent gooseneck injection heads — the most flexible DEYU multi-color machine. Run 3-color stacked soles, or 3 different single-color batches simultaneously, or mix single + dual-color production on one machine.',
    features: [
      '24 stations rotary disc',
      'Three independent gooseneck injection heads',
      'Maximum flexibility: 3-layer stacked soles, 3 single-color runs, or mixed configurations',
      'Materials: PVC / TPR / TPU',
      'Ideal for factories producing multiple sole styles',
      'High-output configuration for medium-large production scale',
    ],
    specifications: {
      'Model': 'DY-3324',
      'Stations': '24',
      ...
      'Material': 'PVC / TPR / TPU',
      'Best For': 'Factories needing single-machine flexibility',
    },
    applications: [
      ...
      'Multi-color sports/casual shoe soles',
    ],
