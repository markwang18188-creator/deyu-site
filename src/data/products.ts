...
export const products: Product[] = [
  ...
  {
    slug: 'one-color-pvc-vacuum-fabric-sole-machine',
    modelSlug: 'dy-1124-vac',
    model: 'DY-1124-VAC',
    name: 'One Color PVC Sole Injection Machine with Vacuum Fabric',
    category: 'single-color',
    shortDescription:
      '24-station one-color PVC sole injection machine with vacuum fabric system. 55T clamping force, Φ65 screw, 660 cm³/shot injection capacity, and 130 pairs/hour productivity.',
    features: [
      'One-color PVC sole injection with vacuum fabric system',
      '24-station rotary layout',
      '55T mold clamping force',
      'Φ65 injecting screw with 660 cm³/shot capacity',
      '130 pairs/hour productivity',
      '480 × 320 × 180 mm mould dimension',
      '31.5 kW total power',
      '600 L oil capacity',
    ],
    specifications: {
      'Model': 'DY-1124-VAC',
      'Stations': '24',
      'Type': 'One-color PVC injection with vacuum fabric',
      'Colors': '1',
      'Screw Diameter': 'Φ65',
      'Max Injection Capacity': '660 cm³/shot',
      'Clamping Force': '55 tons',
      'Max Injection Pressure': '890 kg/cm²',
      'Productivity': '130 pairs/hour',
      'Mould Dimension': '480 × 320 × 180 mm',
      'Total Power': '31.5 kW',
      'Machine Dimension': '5.8 × 4.7 × 2.175 m',
      'Machine Weight': '6.5 tons',
      'Oil Capacity': '600 L',
    },
    applications: [
      'PVC soles with fabric',
      'Vacuum fabric sole production',
      'Single-color PVC footwear soles',
      'Slippers and sandals',
      'High-volume rotary production',
    ],
...

  {
    ...
    model: 'DEYU Single-Color Rotary Sole Mould',
    name: 'Single-Color Sole Mould for Rotary Disc Machines (PVC / TPR / TPU)',
    category: 'moulds',
    shortDescription:
      'The most common single-color sole mould — one sole cavity per mould (one-mould-one-piece). CNC-machined aluminium, compatible with rotary disc injection machines, with the DY-1120 as the typical match. Also runs on the DY-1106 / DY-1108 / DY-1112 platforms. Suits PVC, TPR and TPU soles.',
    features: [
      'One-mould-one-piece — single sole cavity per mould',
      'Typical machine match: DY-1120 (also DY-1106 / DY-1108 / DY-1112)',
      'CNC-machined for precise sole tread detail',
      'Materials: PVC / TPR / TPU',
      'Quick-change clamping standard',
      'Custom shoe size & tread pattern on request',
    ],
    // INTERNAL TODO (Mark): confirm mould material (aluminium alloy grade?),
    // size range, surface treatment, lead time.
    specifications: {
      'Mould Type': 'Single-Color Sole (one-mould-one-piece)',
      'Typical Machine': 'DY-1120',
      'Also Compatible': 'DY-1106 / DY-1108 / DY-1112',
      'Material': 'PVC / TPR / TPU',
      'Cavity Count': '1 sole per mould (multi-cavity on request)',
      'Shoe Size Range': 'On request',
      'Lead Time': 'On request',
    },
    applications: [
      'Single-color PVC / TPR / TPU sole production',
      'Casual footwear soles',
      'Sports shoe soles',
      'OEM/ODM brand production',
      'Sample mould development',
    ],
    mainImage: img('moulds/single-color-sole-mould-dy1120.jpg'),
    gallery: [],
  },
