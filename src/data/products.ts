...
export const products: Product[] = [
...

  {
    ...
    model: 'DY-2112 / DY-2212 / DY-2216',
    name: 'Full Automatic Rotary Two Color TR/TPU Sole Injection Moulding Machine Series',
    category: 'dual-color',
    shortDescription:
      'Dual-color TR/TPU rotary sole machine family. Configurations range from a compact single-head 12-station 110T (DY-2112) to a column-type dual-head 12-station 150T flagship (DY-2212) and a higher-station 16-station 150T (DY-2216). 60-120 pairs/hour.',
    features: [
      'Three configurations: DY-2112 (single-head, 110T) · DY-2212 (column-type dual-head, 150T) · DY-2216 (16-station dual-head, 150T)',
      '12 or 16 stations rotary disc',
      'Materials: TR / TPU (PVC / TPR also supported on DY-2216)',
      'Central water-cooling — rapid mould cooling',
      'Automatic mould-opening robotic arm (DY-2112)',
      'External oil pump on DY-2212 — better heat dissipation, longer machine life',
      'Servo energy-saving system — saves 30%+ electricity',
      'Production: 60-120 pairs/hour by configuration',
    ],
    specifications: {
      'Models': 'DY-2112 (12-station single-head) · DY-2212 (12-station column-type) · DY-2216 (16-station)',
      'Stations': '12 / 16',
      'Configuration': 'Single-head dual-color (DY-2112) · Dual-head (DY-2212 / DY-2216)',
      'Clamping Force': '110 tons (DY-2112) · 150 tons (DY-2212 / DY-2216)',
      'Material': 'TR / TPU (PVC / TPR on DY-2216)',
      'Screw Diameter': 'Φ50/Φ50 (DY-2112) · Φ55/Φ55 (DY-2212 / DY-2216)',
      'Max Injection Capacity': '390 cm³/shot (DY-2112) · 2×500 cm³/shot (DY-2212) · 2×470 cm³/shot (DY-2216)',
      'Max Injection Pressure': '1300 kg/cm² (DY-2112) · 1300/1300 (DY-2212) · 1050 (DY-2216)',
      'Productivity': '80-120 pairs/hour (DY-2112 / DY-2212) · 60-80 pairs/hour (DY-2216)',
      'Cooling': 'Central water-cooling',
      'Total Power': '33 kW (DY-2112) · 60-66 kW (DY-2212 / DY-2216)',
      'Machine Weight': '7 tons (DY-2112) · 20 tons (DY-2212 / DY-2216)',
    },
