        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="aspect-[4/3] bg-[#e2e8f0] rounded-xl flex items-center justify-center">
              ...
              {/* TODO: Replace with <Image src={product.mainImage} ... /> once images are available */}
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-md transition-colors flex items-center gap-2"
                >
                ...
                <Link
                  href="/contact"
                  className="bg-[#ea580c] hover:bg-orange-700 text-white font-semibold px-6 py-3 rounded-md transition-colors"
                >
                  Send an Enquiry
                </Link>
              </div>
      ...
      <section className="py-12 bg-[#f1f5f9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Spec table */}
            <div>
              <h2 className="text-xl font-bold text-[#0f172a] mb-6">Technical Specifications</h2>
            ...
            {/* Applications */}
            <div>
              <h2 className="text-xl font-bold text-[#0f172a] mb-6">Applications</h2>
              ...
              <div className="mt-10 p-6 bg-[#1e3a8a] rounded-xl text-white">
                <h3 className="font-bold text-lg mb-2">Request a Datasheet</h3>
                <p className="text-blue-200 text-sm mb-4">
                  Get the full technical datasheet and a personalised quote for the {product.model}.
                </p>
                <Link
